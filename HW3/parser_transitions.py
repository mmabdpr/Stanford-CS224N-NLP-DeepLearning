...
# from utils.parser_utils import ModelWrapper
...
class DummyModel(object):
    ...
    def unidirectional_predict(self, partial_parses) -> List[str]:
    ...
    def interleave_predict(self, partial_parses) -> List[str]:
...
class PartialParse(object):
    def __init__(self, sentence: List[str]):
        ...
        @param sentence: The sentence to be parsed as a list of words.
        ...
        self.buffer: List[str] = copy.deepcopy(sentence)
    ...
    def parse_step(self, transition: str):
        ...
        if transition == "S":
            ...
            raise IndexError("invalid transition")
    ...
    def parse(self, transitions: List[str]) -> List[Tuple[str, str]]:
        ...
        @return dependencies: The list of dependencies produced when
...
def minibatch_parse(sentences: List[List[str]], model: Union[ParserModel, DummyModel, Any], batch_size: int) \
        -> List[List[Tuple[str, str]]]:
    """Parses a list of sentences in minibatches using a model.

    @param sentences: A list of sentences to be parsed
                                            (each sentence is a list of words and each word is of type string)
    @param model: The model that makes parsing decisions. It is assumed to have a function
    ...
    #     Note that the pseudocode for this algorithm is given in the pdf handout.
    #
    ...
    while any(unfinished_parses):
        minibatch = unfinished_parses[:batch_size]
        for pp, pred in zip(minibatch, model.predict(minibatch)):
            pp.parse_step(pred)
